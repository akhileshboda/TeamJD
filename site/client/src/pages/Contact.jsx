...
export default function Contact() {
  return (
    <div className="contact-page">
      ...
      <section className="contact-gateway" aria-label="Choose how to start">
        <div className="container contact-gateway-grid">
          <SectionReveal className="contact-route contact-route--primary">
            <div>
              ...
              <p>
                Compare Jake&apos;s coaching services and find the structure that matches your
                goal, environment, and level of support.
              </p>
            </div>
            <a className="btn btn-primary btn-lg contact-route-action" href="#contact-services">
              Explore coaching
              <JourneyIcon name="arrowRight" size={18} />
            </a>
          </SectionReveal>

          <SectionReveal className="contact-route contact-route--secondary" delay={0.1}>
            <div>
              <div className="contact-route-icon" aria-hidden="true">
            ...
            <a className="btn btn-outline btn-lg contact-route-action" href="#contact-enquiry">
              Ask Jake
              <JourneyIcon name="arrowRight" size={18} />
            </a>
          </SectionReveal>
